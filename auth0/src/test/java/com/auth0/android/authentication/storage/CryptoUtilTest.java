...
public class CryptoUtilTest {
    ...
    public void shouldTriggerPKCS1MigrationWhenRSADecryptThrowsProviderException() throws Exception {
        ...
        base64Mock.when(() -> Base64.decode(encodedPKCS1, Base64.DEFAULT)).thenReturn(encryptedAESPKCS1);
        base64Mock.when(() -> Base64.encode(reEncryptedOAEP, Base64.DEFAULT))
                .thenReturn(encodedOAEP.getBytes(StandardCharsets.UTF_8));
    ...
    public void shouldDeleteOldRSAKeyBeforeReEncryptingInTryMigrateLegacyAESKey() throws Exception {
        ...
        base64Mock.when(() -> Base64.decode(encodedOldAES, Base64.DEFAULT)).thenReturn(encryptedOldAES);
        base64Mock.when(() -> Base64.encode(encryptedNewAES, Base64.DEFAULT))
