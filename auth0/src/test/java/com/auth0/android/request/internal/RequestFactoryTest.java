...
public class RequestFactoryTest {
    ...
    public void shouldHaveDefaultAcceptLanguageHeader() {
        ...
        factory.get(BASE_URL, resultAdapter,null);
        verify(getRequest).addHeader("Accept-Language", "en_US");

        factory.post(BASE_URL, resultAdapter,null);
        verify(postRequest).addHeader("Accept-Language", "en_US");

        factory.delete(BASE_URL, resultAdapter,null);
        verify(deleteRequest).addHeader("Accept-Language", "en_US");

        factory.patch(BASE_URL, resultAdapter,null);
    ...
    public void shouldCreatePostRequest() {
        Request<String, Auth0Exception> request = factory.post(BASE_URL, resultAdapter,null);
    ...
    public void shouldCreateVoidPostRequest() {
        Request<Void, Auth0Exception> request = factory.post(BASE_URL,null);
    ...
    public void shouldCreatePatchRequest() {
        Request<String, Auth0Exception> request = factory.patch(BASE_URL, resultAdapter,null);
    ...
    public void shouldCreateDeleteRequest() {
        Request<String, Auth0Exception> request = factory.delete(BASE_URL, resultAdapter,null);
    ...
    public void shouldCreateGetRequest() {
        Request<String, Auth0Exception> request = factory.get(BASE_URL, resultAdapter,null);
    ...
    private RequestFactory<Auth0Exception> createRequestFactory() {
        ...
        doReturn(postRequest).when(factory).createRequest(any(HttpMethod.POST.class), eq(BASE_URL), eq(client), eq(resultAdapter), eq(errorAdapter), any(ThreadSwitcher.class),isNull());
        doReturn(emptyPostRequest).when(factory).createRequest(any(HttpMethod.POST.class), eq(BASE_URL), eq(client), AdditionalMatchers.and(AdditionalMatchers.not(ArgumentMatchers.eq(resultAdapter)), ArgumentMatchers.isA(JsonAdapter.class)), eq(errorAdapter), any(ThreadSwitcher.class),isNull());
        doReturn(deleteRequest).when(factory).createRequest(any(HttpMethod.DELETE.class), eq(BASE_URL), eq(client), eq(resultAdapter), eq(errorAdapter), any(ThreadSwitcher.class),isNull());
        doReturn(patchRequest).when(factory).createRequest(any(HttpMethod.PATCH.class), eq(BASE_URL), eq(client), eq(resultAdapter), eq(errorAdapter), any(ThreadSwitcher.class),isNull());
        doReturn(getRequest).when(factory).createRequest(any(HttpMethod.GET.class), eq(BASE_URL), eq(client), eq(resultAdapter), eq(errorAdapter), any(ThreadSwitcher.class),isNull());
        return factory;
    }
}