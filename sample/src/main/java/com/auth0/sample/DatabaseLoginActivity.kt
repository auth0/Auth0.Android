 ...
 */
class DatabaseLoginActivity : AppCompatActivity() {
    ...
    private fun requireView() = findViewById<View>(android.R.id.content)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = FragmentDatabaseLoginBinding.inflate(layoutInflater)
    ...
    private suspend fun passkeySignupAsync(email: String) {
        ...
        try {
            ...
            val result = credentialManager.createCredential(this, request)
    ...
    private suspend fun passkeySigninAsync() {
        try {
            ...
            val result = credentialManager.getCredential(this, getCredRequest)
            when (val credential = result.credential) {
                is PublicKeyCredential -> {
                    val authRequest = Gson().fromJson(
                        credential.authenticationResponseJson,
